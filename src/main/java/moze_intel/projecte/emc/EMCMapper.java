...
public final class EMCMapper {
    ...
    /**
     * Remove all entrys from the map, that are not
     * {@link moze_intel.projecte.emc.NormalizedSimpleStack.NSSItem}s, have a
     * value < 0 or WILDCARD_VALUE as metadata. @param map
     */
